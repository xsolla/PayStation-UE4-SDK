...
struct XSOLLAPAYMENTS_API FXsollaLoginRequest
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct XSOLLAPAYMENTS_API FXsollaLoginResult
{
	GENERATED_BODY()
public:
...
struct XSOLLAPAYMENTS_API FXsollaPlayFabCatalogItem
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Xsolla|PlayFab Wrapper|Items")
...
struct XSOLLAPAYMENTS_API FXsollaApiErrorWrapper
{
	...
	/** Numerical HTTP code */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Xsolla|PlayFab Wrapper|Error")
	int32 Code;
...
struct XSOLLAPAYMENTS_API FXsollaRegisterRequest
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Xsolla|PlayFab Wrapper|Register")
	FString DisplayName;
